...
// Special controller for Inkbook Focus Plus; may work for Inkbook Focus?
class Light_InkbookFocusPlus : Ioctl(), LightsInterface {
    companion object {
    ...
    override fun InkBookSDK.getBrightness(activity: Activity): Int {
        return try {
    ...
    override fun InkBookSDK.getTemperature(activity: Activity): Int {
        return try {
    ...
    override fun InkBookSDK.setBrightness(activity: Activity, brightness: Int) {
    ...
    override fun InkBookSDK.setTemperature(activity: Activity, warmth: Int) {
